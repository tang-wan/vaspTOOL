...
class POSCARRead():
    def __init__(self, path, p=False):
        ...
        # print(Symbols)
        print(f"This POSCAR/CONTCAR is {Formula}")
        print("---")
    ...
    def LayerHeight(self):
        ...
        print("----")
        print("LayerHeight difference (Å):")
    ...
    def AtomDistance(self, TargetAtom_1, TargetAtom_2, p=(False, False)): # Atom2 - Atom1
        ...
        print(f"Atom Distance ({self.Symbols[TargetAtom_1]} - {self.Symbols[TargetAtom_2]}):")
    ...
    def AtomAngle(self, TargetAtom_1, TargetAtom_2, TargetAtom_3, p=(False, False, False)):
        ...
        print(f"The angle ({self.Symbols[TargetAtom_1]}-{self.Symbols[TargetAtom_2]}-{self.Symbols[TargetAtom_3]}) is:")
...
class POSCAREdit():
    ...
    def HeteroStructure(self, top_path, vdw=3.20, Vac=15.0):
        ...
        self.Struct = hetero
        print(f"Heterostructure built! Top layer loaded from: {top_path}")
# ==========================
    ...
    def WritePOSCAR(self, name):
        ...
        ase.write(name, sorted_supercell, 
                ...
                vasp5=True, 
                direct=True)
        print(f"Writing POSCAR Finished: {name}")

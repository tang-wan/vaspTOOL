...
class procarSTplot():
    def __init__(self, FilePath:str, fermiEnergy=0, PROCARtype='vasp', spin_mode='all'):
        ...
        # nkpoint is not affected by spin and remains unchanged
...
"""
        ...
        # ----------------- Declare all plotting settings as instance attributes ----------------- #
...
# ==========
    def Read_SpinData_projectionData(self, spinList=(0,)):
        ...
        if n_spins == 1:
            ...
            # Handle Collinear situation based on spin_mode
...
# ==========
    def Read_OrbitalData_projectionData(self, orbitalList=None, table=0):
        ...
        if n_spins == 1:
            ...
            orbitalData_down = self.parser.ebs.ebs_sum(atoms=None, orbitals=orbitalList, spins=None)[:,:,1]*(-1)
...
# ==========
    def Read_AtomCompData_projectionData(self, atomList1:list, atomList2:list, type="1-2"):
        ...
        # Calculate the difference between the two atoms
        if type == "1-2":
